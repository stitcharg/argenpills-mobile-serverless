...
if (ENV_DEV) {
    ...
    sandboxImageCertificate = new aws.acm.Certificate(nameImages, {
        domainName: configImagesDomain,
        validationMethod: "DNS",
    }, { import: "arn:aws:acm:us-east-1:REDACTED:certificate/9a4c63c7-ba6a-460c-828a-2ac49192b88a"});
}
...
if (ENV_DEV) {
    ...
    sandboxApiCertificate = new aws.acm.Certificate(nameApi, {
        domainName: configAPIHost,
        validationMethod: "DNS",
    }, { import: "arn:aws:acm:us-east-1:REDACTED:certificate/ec1e42b9-045b-494f-b45c-f7d740e6afc2"});    
}
